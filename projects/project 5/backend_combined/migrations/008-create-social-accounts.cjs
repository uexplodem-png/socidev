...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.addIndex('social_accounts', ['username']);
    await queryInterface.addIndex('social_accounts', ['verification_status']);
    await queryInterface.addIndex('social_accounts', ['platform', 'username'], { unique: true });
  },
