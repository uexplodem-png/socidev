...
export const XOrderForm = () => {
  ...
  useEffect(() => {
    const fetchServices = async () => {
      try {
        setLoading(true);
        const response = await getServicesByPlatform("x");
        ...
        setServices([
          {
            id: "likes",
            name: t("xLikes") || "X Likes",
            icon: ThumbsUp,
            description: t("xLikesDescription") || "Get real X (Twitter) likes",
            basePrice: 0.5,
            minQuantity: 100,
            maxQuantity: 50000,
            pricePerUnit: 0.5,
            ...
            urlExample: "https://x.com/username/status/123456",
          },
          {
            id: "followers",
            name: t("xFollowers") || "X Followers",
            icon: Users,
            description: t("xFollowersDescription") || "Grow your X followers",
            basePrice: 1.0,
            minQuantity: 100,
            maxQuantity: 25000,
            pricePerUnit: 1.0,
            ...
            urlExample: "https://x.com/username",
          },
          {
            id: "views",
            name: t("xViews") || "X Views",
            icon: Eye,
            description: t("xViewsDescription") || "Increase X tweet views",
            basePrice: 0.2,
            minQuantity: 500,
            maxQuantity: 100000,
            pricePerUnit: 0.2,
          ...
          {
            id: "comments",
            name: t("xComments") || "X Comments",
            icon: MessageCircle,
            description: t("xCommentsDescription") || "Get X comments",
            basePrice: 2.0,
            minQuantity: 10,
            maxQuantity: 1000,
            pricePerUnit: 2.0,
            ...
            return (
              <div
                ...
                <div className='flex items-start gap-4'>
                  <div
                    className={`p-3 rounded-lg ${isSelected ? "bg-gray-200" : "bg-gray-100"
                      }`}>
                    <Icon
                      className={`w-6 h-6 ${isSelected ? "text-gray-900" : "text-gray-600"
                        }`}
                    />
                  </div>
                  ...
                  <div className='mt-4 space-y-4'>
                    <div className='space-y-2'>
                      ...
                      <input
                        ...
                        className='w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-gray-900 focus:ring-gray-200'
                      />
                    ...
                    <div className='space-y-2'>
                      ...
                      <div className='relative'>
                        ...
                        <input
                          ...
                          className='w-full pl-9 pr-3 py-2 rounded-lg border border-gray-300 focus:border-gray-900 focus:ring-gray-200'
                        />
                      </div>
                    </div>
            ...
            {speeds.map(({ id, name, description, icon: Icon, price }) => (
              <button
                ...
                <div className='flex items-center gap-3 mb-2'>
                  <div
                    className={`p-2 rounded-lg ${selectedSpeed === id ? "bg-gray-200" : "bg-gray-100"
                      }`}>
                    <Icon
                      className={`w-5 h-5 ${selectedSpeed === id ? "text-gray-900" : "text-gray-500"
                        }`}
                    />
                  </div>
                  <div>
                    <p
                      className={`font-medium ${selectedSpeed === id ? "text-gray-900" : "text-gray-900"
                        }`}>
                      {name}
                    </p>
