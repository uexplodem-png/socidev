...
export const YoutubeOrderFormOld = () => {
    const { t } = useLanguage();
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    <div className={`p-3 rounded-lg ${isSelected ? 'bg-red-100' : 'bg-gray-100'
                                        }`}>
                        ...
                        {speeds.map(({ id, name, description, icon: Icon, price }) => (
                            ...
                            >
                                <div className="flex items-center gap-3 mb-2">
                                    <div className={`p-2 rounded-lg ${selectedSpeed === id ? 'bg-red-100' : 'bg-gray-100'
                                        }`}>
                                        <Icon className={`w-5 h-5 ${selectedSpeed === id ? 'text-red-600' : 'text-gray-500'
                                            }`} />
                                    </div>
                                    <div>
                                        <p className={`font-medium ${selectedSpeed === id ? 'text-red-600' : 'text-gray-900'
                                            }`}>
                                            {name}
                                        </p>
