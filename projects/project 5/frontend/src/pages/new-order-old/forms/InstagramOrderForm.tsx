...
export const InstagramOrderFormOld = () => {
  const { t } = useLanguage();
            ...
            return (
              <div
                ...
                <div className='flex items-start gap-4'>
                  <div
                    className={`p-3 rounded-lg ${isSelected ? "bg-pink-100" : "bg-gray-100"
                      }`}>
                    <Icon
                      className={`w-6 h-6 ${isSelected ? "text-pink-600" : "text-gray-600"
                        }`}
                    />
                  </div>
            ...
            {speeds.map(({ id, name, description, icon: Icon, price }) => (
              <button
                ...
                <div className='flex items-center gap-3 mb-2'>
                  <div
                    className={`p-2 rounded-lg ${selectedSpeed === id ? "bg-pink-100" : "bg-gray-100"
                      }`}>
                    <Icon
                      className={`w-5 h-5 ${selectedSpeed === id ? "text-pink-600" : "text-gray-500"
                        }`}
                    />
                  </div>
                  <div>
                    <p
                      className={`font-medium ${selectedSpeed === id ? "text-pink-600" : "text-gray-900"
                        }`}>
                      {name}
                    </p>
