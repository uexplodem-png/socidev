...
const getServiceIcon = (serviceName: string): React.ElementType => {
  ...
  if (lower.includes('retweet') || lower.includes('repost')) return MessageCircle;
  return Shield;
};
...
export const XOrderForm = () => {
    ...
    return (
      <Card className="p-6 bg-yellow-50 border-yellow-200">
        <div className="text-yellow-600">
          ...
          <p className="text-sm">X (Twitter) services are not yet configured.</p>
        </div>
      </Card>
    );
  }
  ...
  return (
    <div className='space-y-8'>
      ...
      {/* Order Summary */}
      <Card className='p-6 bg-gradient-to-r from-gray-100 to-gray-200'>
        ...
        <Button
          ...
          className='w-full mt-6 bg-black hover:bg-gray-900 text-white py-3 rounded-lg font-semibold transition-colors'>
          {t("placeOrder")}
        </Button>
      </Card>
    </div>
